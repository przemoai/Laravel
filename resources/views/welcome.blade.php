        ...
        <div class="container pt-5">
            <div class="row">
                <div class="col-md-8 order-md-2 col-lg-9">
                    ...
                    <h6 class="text-uppercase mt-5 mb-3 font-weight-bold">{{__('harnasik.welcome.price')}}</h6>
                    ...
                    <div class="divider mt-5 mb-5 border-bottom border-secondary"></div>
                    <a href="#" class="btn btn-lg btn-block btn-primary mt-5">{{__('harnasik.welcome.filter')}}</a>
                </div>
