...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{__('tlumaczenie.product.show.header')}}</div>
                ...
                <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{__('tlumaczenie.product.fields.image')}}</label>
